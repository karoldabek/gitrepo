...
<li class="nav-item">
    ...
    if ($t['id'] == $id) {
    	echo ' active'; // spacja przed active jest bardzo ważna
    	$strona = $t;
    }
...
function get_page_title($strona) {
	if (array_key_exists('tytul', $strona))  //funkcja kóra sie pyta czy dany klucz istnieje na stronie
		echo $strona['tytul'];
	else
		echo 'Aplikacja PHP';
}
